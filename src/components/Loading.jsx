...
const loading = () => {
    return (
        ...
        <div id="fountainTextG"><div id="fountainTextG_1" className="fountainTextG">C</div>
        <div id="fountainTextG_2" className="fountainTextG">a</div>
        ...
        <div id="fountainTextG_11" className="fountainTextG">.</div>
        <div id="fountainTextG_12" className="fountainTextG">.</div></div>
